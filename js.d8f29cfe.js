...
},{"./gsap-core.js":"P74P","./CSSPlugin.js":"KE4Q"}],"MgTz":[function(require,module,exports) {
"use strict";
...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.onScaleMouse(); // mouse move function
  ...
  _createClass(Cursor, [{
    ...
    value: function render() {
      ...
      for (var key in this.cursorConfig) {
        this.cursorConfig[key].pre = (0, _utils.lerp)(this.cursorConfig[key].pre, this.cursorConfig[key].curnt, this.cursorConfig[key].amt);
      }

      this.Cursor.style.transform = "translate(".concat(this.cursorConfig.x.pre, "px,").concat(this.cursorConfig.y.pre, "px)");
      requestAnimationFrame(function () {
    ...
    value: function onScaleMouse() {
      ...
      this.Item.forEach(function (link) {
        link.addEventListener("mouseenter", function (e) {
          _this3.selectElement(link, 0.4);
        });
        link.addEventListener("mouseleave", function (e) {
          _this3.selectElement(link, 0);
        });
        link.children[1].addEventListener("mouseenter", function (e) {
          _this3.selectElement(link, 0.8);
        });
      });
    }
  }, {
    key: "selectElement",
    value: function selectElement(el, scale) {
      var _this4 = this;

      var src = el.getAttribute("data-vedio-src");
      var video = document.querySelector("#".concat(src));
      document.querySelectorAll(".cursor-media").forEach(function (cursorMedia) {
        if (cursorMedia.children[0].getAttribute("id") == src) {
          _this4.scaleAnimation(cursorMedia, scale);
        } else {
    ...
    key: "scaleAnimation",
    value: function scaleAnimation(element, scale) {
      var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.6;
...
},{"gsap":"f8Z0","./utils":"MgTz"}],"QvaY":[function(require,module,exports) {
"use strict";
...
},{"./cursor":"LMRJ","gsap":"f8Z0"}]},{},["QvaY"], null)
//# sourceMappingURL=js.d8f29cfe.js.map